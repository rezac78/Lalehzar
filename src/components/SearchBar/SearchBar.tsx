        ...
        return (
                <div className="flex items-center justify-center">
                        <div className="flex border border-buttonColor w-auto rounded-lg">
                                ...
                                <PartButton IdName={'MagnifyingGlassIcon'} className="flex items-center justify-center px-4 border-none rounded-l-lg bg-buttonColor hover:bg-buttonHoverColor">
